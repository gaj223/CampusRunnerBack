...
public class EditProductActivity extends Activity {
    ...
    // single product url
    private static final String url_product_detials = "http://13.59.142.19/CampusRunnerBack/yadi_test/TestHiveStuff/get_product_details.php";

    // url to update product
    private static final String url_update_product = "http://13.59.142.19/CampusRunnerBack/yadi_test/TestHiveStuff/update_product.php";
